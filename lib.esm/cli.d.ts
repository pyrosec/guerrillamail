...
import "setimmediate";
export declare function saveSession(guerrillamail: any, json?: boolean, filename?: string): Promise<void>;
export declare function initSession(): Promise<void>;
export declare function loadSession(): Promise<GuerrillaMail>;
